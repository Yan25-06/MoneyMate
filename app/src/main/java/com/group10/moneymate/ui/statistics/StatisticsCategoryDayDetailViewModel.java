...
public class StatisticsCategoryDayDetailViewModel extends ViewModel {
    ...
    public StatisticsCategoryDayDetailViewModel(@NonNull TransactionRepository transactionRepository,
        ...
        dailyGroups.addSource(filterState, value -> reloadDailySource());
    ...
    private void reloadComparisonSources() {
        ...
        comparisonCurrentSource = buildMonthlyComparisonSource(currentFilter, currentMonth, visibleEnd);
    ...
    public static class Factory implements ViewModelProvider.Factory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            if (modelClass.isAssignableFrom(StatisticsCategoryDayDetailViewModel.class)) {
                return (T) new StatisticsCategoryDayDetailViewModel(
