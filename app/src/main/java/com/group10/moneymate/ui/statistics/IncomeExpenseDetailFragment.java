...
public class IncomeExpenseDetailFragment extends Fragment {
    ...
    private void renderComparisonChart(@Nullable List<IncomeExpenseDetailViewModel.ComparisonPointUiModel> items) {
        ...
        currentDataSet.setCircleColor(primaryColor);
        currentDataSet.setCircleRadius(2.5f);
        currentDataSet.setLineWidth(2.6f);
        ...
        averageDataSet.setCircleColor(ContextCompat.getColor(requireContext(), R.color.statistics_text_muted));
        averageDataSet.setCircleRadius(2f);
        averageDataSet.setLineWidth(2f);
        averageDataSet.setDrawValues(false);

        binding.chartComparison.setData(new LineData(currentDataSet, averageDataSet));
    ...
    private void updateComparisonVisibility() {
        ...
        binding.chartComparison.setVisibility(showCard && isComparisonVisible ? View.VISIBLE : View.GONE);
